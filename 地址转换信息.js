...
var prov = a["0"];
for (var aIndex in prov) {
	finalData[aIndex] = {
		name: prov[aIndex],
		next: {}
	};
	var city = a["0_" + aIndex];
	for (var bIndex in city) {
		finalData[aIndex].next[aIndex + "_" + bIndex] = {
			name: city[bIndex],
			next: {}
		};
		var country = a["0_" + aIndex + "_" + bIndex];
		for (var cIndex in country) {
			finalData[aIndex].next[aIndex + "_" + bIndex].next[aIndex + "_" + bIndex + "_" + cIndex] = country[cIndex]
		}
	}
}
