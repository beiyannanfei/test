...
exports.groupCondition = function(condition, token, tvmId){
    if (token){
        condition.token = token
        delete condition.tvmId
    } else {
        condition.tvmId = tvmId
        condition.token = {$exists: false}
    }
    return condition;
}

exports.groupOrderCondition = function(condition, token, tvmId){
    if (token){
        condition.token = token
        delete condition.tvmId
    } else {
...
exports.groupGoodsCondition = function(condition, token, tvmId){
    if (token){
        condition.token = token
        delete condition.tvmId
    } else {
...
exports.groupDoc = function(doc, token, tvmId){
    if (token){
        doc.token = token
    }
    if (tvmId){
...
exports.groupConditionWithToken = function(condition, token, tvmId){
    if (token){
        condition.token = token
    }
    if (tvmId){
...
exports.groupDocWithToken = function(doc, token, tvmId){
    if (token){
        doc.token = token
    }
    if (tvmId){
