		...
		_createDOM:function(data){
			...
			var html = [
    			...
    			'<div class="layer_w_cj">',
      			'<div class="header">添加商品规格<span class="closeLayer">'+this.svg+'</span></div>',
				'<div class="con">',
				'<div class="frm">',
				'<span class="tile">填写规格标题：</span>',
				'<input type="text" class="inputText inputTile" placeholder="规格标题" value="'+title+'">',
				'</div>',
				'<div class="frm">',
            	...
            	items,
          		'</div>',
          		'<div class="additem" data-status="true"><span class="btn btn_lg btn_primary"><button type="button">添加规格</button></span><span class="input"><input type="text" class="inputText" placeholder="输入规格"></span></div>',
				'</div>',
				'</div>',
				'<div class="btn_group">',
