...
+"#dialog{position:absolute;top:30%;right:10%;left:10%;z-index:1;background-color:#f0f1f2;border-radius:4px;overflow:auto}"
...
+".closeButton{position:absolute;width:40px;height:40px;right:6px;top:2px;color:white;line-height:40px;font-size:14px}"
+".dialogTitle{height:20px;font-size:18px;background-color:#252525;color:#fff;padding:10px;margin:0;border-radius:4px 4px 0 0;text-align:center}"
...
+"@-webkit-keyframes hidd{0%{-webkit-transform:scale(1);opacity:1 }30%{-webkit-transform:scale(1.05);opacity:1}50%{-webkit-transform:scale(0.8);opacity:0.8 }100%{-webkit-transform:scale(1.2);opacity:0}}"
