...
$(function(){
    function InitWxJsParam(err, data){
        ...
        wx.config({
            ...
            jsApiList: ['checkJsApi','openCard','chooseCard', 'hideOptionMenu', 'showOptionMenu', 'onMenuShareTimeline','onMenuShareAppMessage', 'hideMenuItems', 'showMenuItems', 'previewImage', 'scanQRCode'],
            success: function(){
