...
var yaoTVApi = require('./yaoTVApi.js');
...
exports.taskCreate = function(ACCESS_TOKEN, params, cb){
    console.log(params)
    var url = 'https://api.weixin.qq.com/card/task/create?access_token=' + ACCESS_TOKEN
    httpUtils.httpPostJSONTuf8(url, params, function(err, response){
        console.log(response)
        if (err){
            cb(err)
...
exports.cardDetail = function(ACCESS_TOKEN, params, cb){
    console.log(params)
