...
function userGroupSig(){

    var openId = 'oux1puLLtHRV-mEyIz0EXNd17zHo';
    var sigtime = new moment().valueOf().toString();
    var key = '10059d4ceefa51dd21d00898d891f58d';
    var str = openId+':'+key+':'+sigtime;
    var md5 = crypto.createHash('md5');
    var sig = md5.update(str);
    sig = md5.digest('hex');
...
//        url = 'http://127.0.0.1:6001/pointMall/group/user/add';
//        url = 'http://hudong-qa.tvmining.com/pointMall/userGroup/add';
    var url = 'http://mall.mtq.tvm.cn/pointMall/group/user/add';
    console.log({
        sig:sig,
        sigtime:sigtime,
        'openId':openId,//,oX7GJjumQe8BZ0-DSDEm3SHsmyjw,oPKamjsl7wGIC9JrvmKkEPP8pvCs',// 'oX7GJjumQe8BZ0-DSDEm3SHsmyjw',//'oPKamjsl7wGIC9JrvmKkEPP8pvCs', //
...
//        url = 'http://hudong-qa.tvmining.com/pointMall/userGroup/add';
    request.post(url)
        .type('json')
        .send({
            'openId':'of2aQjvBml-3RxynWXZ0K6kGQ5wc',//,oX7GJjumQe8BZ0-DSDEm3SHsmyjw,oPKamjsl7wGIC9JrvmKkEPP8pvCs',// 'oX7GJjumQe8BZ0-DSDEm3SHsmyjw',//'oPKamjsl7wGIC9JrvmKkEPP8pvCs', //
            'wxToken':'df1596792613d19a',// 'tvmcj',//'8e8c547795a5fe3c', //
            'activity': '社区',
            'title': '【战果提醒】中超第14轮，您最想收到哪个队的比赛赛果？',
            'result': '点赞'
        }).end(function (err, res) {
            if (err) {
                console.log(err);
