...
function decode(str, key) {
	...
	let keysByte = stringToBytes(key);
	let dataByte = new Array();
	for (let i = 0; i < list.length; i++) {
		dataByte[i] = parseInt(list[i]) - (0xff & parseInt(keysByte[i % keysByte.length]));
		console.log(dataByte[i])
	}
	...
	let parseStr = bytesToString(dataByte);
	return parseStr;
}
...
<?xml version="1.0" encoding="UTF-8" standalone="no"?>
	<skymoons_message>
	  <message>
	    ...
	    <channel_uid>nk_c2yxj6dk6imlgnyhvf</channel_uid>
	    <game_order>b7ff3a5bac1243ea8991bbc8eb5daaaf</game_order>
	    <order_no>24120160722105250913157993</order_no>
	    <pay_time>2016-07-22 10:52:50</pay_time>
	    <amount>1.00</amount>
	    <status>0</status>
